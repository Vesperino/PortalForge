...
namespace PortalForge.Infrastructure.Migrations
{
    ...
    [Migration("20251106162754_AddQuizFieldsToApprovalStep")]
    partial class AddQuizFieldsToApprovalStep
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortalForge.Domain.Entities.Department", b =>
                {
                    ...
                    b.HasIndex("DirectorSubstituteId");

                    b.HasIndex("HeadOfDepartmentId");

                    b.HasIndex("HeadOfDepartmentSubstituteId");
            ...
            modelBuilder.Entity("PortalForge.Domain.Entities.QuizQuestion", b =>
                {
                    ...
                    b.Property<Guid>("RequestApprovalStepTemplateId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("RequestApprovalStepTemplateId", "Order");
            ...
            modelBuilder.Entity("PortalForge.Domain.Entities.RequestApprovalStep", b =>
                {
                    ...
                    b.HasIndex("RequestApprovalStepTemplateId");
            ...
            modelBuilder.Entity("PortalForge.Domain.Entities.RequestApprovalStepTemplate", b =>
                {
                    ...
                    b.Property<string>("ApproverType")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasDefaultValue("DirectSupervisor");
                    ...
                    b.Property<int>("SpecificDepartmentRoleType")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PortalForge.Domain.Entities.Department", b =>
                {
                    ...
                    b.HasOne("PortalForge.Domain.Entities.User", "DirectorSubstitute")
                        .WithMany()
                        .HasForeignKey("DirectorSubstituteId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("PortalForge.Domain.Entities.User", "HeadOfDepartmentSubstitute")
                        .WithMany()
                        .HasForeignKey("HeadOfDepartmentSubstituteId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("PortalForge.Domain.Entities.QuizQuestion", b =>
                {
                    b.HasOne("PortalForge.Domain.Entities.RequestApprovalStepTemplate", "RequestApprovalStepTemplate")
                        .WithMany("QuizQuestions")
                        .HasForeignKey("RequestApprovalStepTemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RequestApprovalStepTemplate");
                });
            ...
            modelBuilder.Entity("PortalForge.Domain.Entities.RequestApprovalStep", b =>
                {
                    ...
                    b.HasOne("PortalForge.Domain.Entities.RequestApprovalStepTemplate", "ApprovalStepTemplate")
                        .WithMany()
                        .HasForeignKey("RequestApprovalStepTemplateId");
                    ...
                    b.Navigation("ApprovalStepTemplate");
