...
// Tabs
const activeTab = ref<'new' | 'my-requests' | 'services'>('new')
      ...
      <nav class="-mb-px flex space-x-8">
        ...
        >
          <span class="flex items-center gap-2">
            ...
            Serwisy wewnętrzne
            <span class="inline-flex items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900 px-2 py-0.5 text-xs font-bold text-blue-800 dark:text-blue-200">
