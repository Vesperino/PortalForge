...
async function loadNews() {
  ...
  try {
    ...
    content.value = news.content // TinyMCE works directly with HTML
    ...
    eventLatitude.value = news.eventLatitude || undefined
    eventLongitude.value = news.eventLongitude || undefined
